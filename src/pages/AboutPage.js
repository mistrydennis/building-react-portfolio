...
function AboutPage(props) {
    ...
    return(
        <div>
            ...
            <Content>
            <p>Hello, my name is Dennis. I'm a full stack engineer with experience in  Java,Python,Oracle SQL,HTML5,CSS,React JS</p>

            <p>My dream is to one day start my own business and become an entrepreneur</p>

            <p>As we know,learning is a continual process.I am currently learning React,Mongo DB</p>
